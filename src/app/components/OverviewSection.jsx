          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div>
              ...
              <div className="space-y-4 mb-8">
                <p className="text-[#010c29] text-base font-light leading-relaxed">
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-2">
                  ...
                  <span className="text-[#010c29] text-base font-light">Real-time monitoring of devices and sensors</span>
                </div>
                <div className="flex items-start gap-2">
                  <Check className="text-red-500" />
                  <span className="text-[#010c29] text-base font-light">Centralized dashboard for all assets</span>
                </div>
                <div className="flex items-start gap-2">
                  <Check className="text-red-500" />
                  <span className="text-[#010c29] text-base font-light">Scalable from single device to large deployments</span>
                </div>
                <div className="flex items-start gap-2">
                  <Check className="text-red-500" />
                  <span className="text-[#010c29] text-base font-light">Intelligent alerts and automation triggers</span>
                </div>
                <div className="flex items-start gap-2">
                  <Check className="text-red-500" />
                  <span className="text-[#010c29] text-base font-light">Secure and reliable data handling</span>
                </div>
              </div>
            </div>
