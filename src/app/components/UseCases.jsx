  ...
  return (
    <div className="bg-[#e8f0ff] py-20 px-12">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Description */}
        <p className="text-[#010c29] text-base font-light mb-12">
        ...
        <div className="space-y-4">
          {useCases.map((useCase, index) => (
            <div
              key={index}
              className="bg-[rgba(255,85,0,0.12)] border border-[rgba(255,136,0,0.23)] rounded-2xl p-6 flex items-start gap-4"
            >
              {/* Icon */}
              <div className="shrink-0 mt-1">
                <useCase.icon className="w-8 h-8 text-[#ff5700]" />
              </div>

              {/* Content */}
              <div>
                <h3 className="text-[#0a1c50] text-lg font-bold mb-2">
                  {useCase.title}
                </h3>
                <p className="text-[#071540] text-base font-light leading-relaxed">
                  {useCase.description}
                </p>
              </div>
            </div>
